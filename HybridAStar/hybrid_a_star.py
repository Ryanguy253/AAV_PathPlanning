...
def calc_motion_inputs():
    '''
    This function generates all possible motion commands for a robot or vehicle: each steering angle paired with forward/backward motion.
    '''
...
def main():
    ...
    for i in range(60): # Bottom Line
        ox.append(i)
        oy.append(0.0)
    for i in range(60): # Right line
        ox.append(60.0)
        oy.append(i)
    for i in range(61): # Top line
        ox.append(i)
        oy.append(60.0)
    for i in range(61): # Left Line
        ox.append(0.0)
        oy.append(i)
    ...
    for _ in range(num_obstacles):
        ox.append(random.uniform(5, width - 5))
        oy.append(random.uniform(5, height - 5))
    ...
    goal = [45.0, 25.0, np.deg2rad(-90.0)]
